...
M.launch=function()
{
	...
	M.init=function(div)
	{
		...
		var str='';
		str+='<style>'+
		'#templeBG{background:url(img/shadedBorders.webp),url(img/BGpantheon.webp);background-size:100% 100%,auto;position:absolute;left:0px;right:0px;top:0px;bottom:16px;}'+
		...
		'.templeGod{box-shadow:4px 4px 4px #000;cursor:pointer;position:relative;color:#f33;opacity:0.8;text-shadow:0px 0px 4px #000,0px 0px 6px #000;font-weight:bold;font-size:12px;display:inline-block;width:60px;height:74px;background:url(img/spellBG.webp);}'+
