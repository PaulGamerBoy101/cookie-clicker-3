/* CC3 language module for "english" (ported from the 2.048 loc/EN.js file).
 * The engine's AddLanguage() consumes { id, name, strings } at boot. */
import type { LanguageData } from "../types";

export default { id: "EN", name: "english", strings: {
	...
	"Compared to the original browser version: no ads, no trackers and no CDN requests (fonts included), an offline-capable PWA with a self-updating service worker, and a one-column layout for phones.": "/",
	"Music by Bert Cole.": "/",
	"Where the project is headed: %1.": "/",
	...
	"Browse the tree": "/",
	"Back to game": "/",
	"You are just looking around.<br>Drag the screen around<br>or use arrow keys!<br>Nothing will be reset.<br>Click Back when you're done.": "/",
